    ...
    <div class="main-content">
        <main>
            ...
            <div class="page-content">
                ...
                <a onclick="openPopup('addPopup')"class="button">Add Destination Content</a>
                    <div id="addPopup" class="popup">
                    <div class="popup-content">
                        <!-- Close button -->
                        <span class="close" onclick="closePopup('addPopup')">&times;</span>
                        <!-- Your form HTML content -->
                        <h2 style="color:black">Destination Form</h2>
                        <form>
                            <div class="img">
                            ...
                            <div class="text p-4">
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tour-name" name="tour-name" placeholder="Enter tour name">
                                    </div>
                                    <div class="form-group">
                        ...
                        <table width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="las la-sort"></span> TOUR NAME</th>
                                                            ...
                                                            <div class="data-column">
                                                                <div class="text p-4">
                                                                    <div class="form-row">
                                                                        <div class="form-group">
                                                                            <label for="tour-name">Tour Name:</label>
                                                                            <input type="text" name="tour-name" placeholder="Enter tour name" value="<?php echo$row[''] ?>"required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="price">Price per person:</label>
                                                                            <input type="text" name="price" placeholder="Enter price" value="<?php echo$row[''] ?>"required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-row">
                                                                        <div class="form-group">
                                                                            <label for="tour-duration">Tour Duration:</label>
                                                                            <input type="text" name="tour-duration" placeholder="Enter tour duration" value="<?php echo$row[''] ?>"required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="location">Location:</label>
                                                                            <input type="text" name="location" placeholder="Enter location" value="<?php echo$row[''] ?>"required>
                                                                        </div>
                                                                    </div>
                                                                    <label for="amenities">Amenities:</label>
                                                                    <textarea name="amenities" placeholder="Enter amenities" value="<?php echo$row[''] ?>"required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
