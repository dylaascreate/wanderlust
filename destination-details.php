  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="hotel.php">Hotel <i class="fa fa-chevron-right"></i></a></span> <span>Hotel Details <i class="fa fa-chevron-right"></i></span></p>
